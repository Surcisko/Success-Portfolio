...
export const Nav = () => {
  ...
  return (
    <nav className="fixed bg-transparent backdrop-blur-md py-4 md:py-5 top-0 w-full border-b border-primary/50 z-10">
      <header className="flex items-center justify-between w-full max-w-7xl px-6 md:px-0 mx-auto text-white">
        <a
          href="/"
        ...
        <div className="md:hidden">
          ...
          {isOpen && (
            <>
              ...
              <div className="bg-gray-700/70  backdrop-blur-2xl absolute z-100 top-0 right-0 w-[60vw] min-h-screen">
